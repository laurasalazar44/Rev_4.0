...
micanvas.pack()
micanvas.create_text(width/2, 100, text = "CUIDA A TUS PLANTAS", anchor = CENTER, font = ("Times", "38", "bold"), fill = "forest green")
...
def img_r():
    ...
    canvas.create_text(width/2, 50, text = "RIEGO", anchor = CENTER, font = ("Times", "38", "bold"), fill = "forest green")
...
def img_p():
    ...
    canvas2.create_text(width/2, 50, text = "NO PLAGAS", anchor = CENTER, font = ("Times", "38", "bold"), fill = "forest green")
...
def img_d():
    ...
    canvas3.create_text(width/2, 50, text = "DISTRIBUCIÓN", anchor = CENTER, font = ("Times", "38", "bold"), fill = "forest green")
...
def img_rob():
    ...
    canvas4.create_text(width/2, 100, text = "RECOLECTA", anchor = CENTER, font = ("Times", "38", "bold"), fill = "forest green")
